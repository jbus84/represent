...
class TargetGeneratorFactory:
    ...
    def register(cls, name: str, generator_class: Type[TargetGenerator]) -> None:
        ...
        if not issubclass(generator_class, TargetGenerator):
            raise ValueError(f"Generator class must implement TargetGenerator interface")
...
def _register_builtin_generators():
    ...
    try:
        ...
        TargetGeneratorFactory.register("global_threshold_classification", GlobalThresholdClassificationGenerator)
