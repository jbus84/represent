...
from tests.unit.reference_implementation import reference_pipeline, PRICE_LEVELS, TIME_BINS
...
class TestDataValidation:
    ...
    def test_handles_price_gaps(self):
        ...
        from tests.unit.fixtures.sample_data import create_edge_case_data
...
class TestCompatibilityMatrix:
    ...
    def test_different_price_levels(self, base_price):
        ...
        data = generate_realistic_market_data(n_samples=50000, base_price=base_price, seed=42)
        result = reference_pipeline(data)
    ...
    def test_different_spreads(self, spread):
        ...
        data = generate_realistic_market_data(
            n_samples=50000, base_price=0.6600, spread=spread, seed=42
        )
        result = reference_pipeline(data)
