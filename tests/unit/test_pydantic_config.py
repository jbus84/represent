...
class TestConfigurationIntegration:
    ...
    def test_config_serialization_roundtrip(self):
        ...
        assert restored_config.classification.true_pip_size == original_config.classification.true_pip_size
        assert restored_config.sampling.sampling_mode == original_config.sampling.sampling_mode
        assert restored_config.sampling.coverage_percentage == original_config.sampling.coverage_percentage
