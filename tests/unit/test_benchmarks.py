...
class TestLatencyBenchmarks:
    ...
    def test_single_array_generation_latency(self, sample_data_full, performance_metrics):
        ...
        assert validation["array_generation_duration_ms"], (
            f"Array generation took {duration_ms:.2f}ms, target was {targets['array_generation_duration_ms']}ms"
        )
...
class TestThroughputBenchmarks:
    ...
    def test_sustained_throughput(self, performance_metrics):
        ...
        assert validation["sustained_throughput_rps"], (
            f"Sustained throughput was {throughput_rps:.0f} rps, target was {targets['sustained_throughput_rps']} rps"
        )
    ...
    def test_peak_throughput(self, sample_data_full, performance_metrics):
        ...
        assert validation["peak_throughput_rps"], (
            f"Peak throughput was {peak_throughput:.0f} rps, target was {targets['peak_throughput_rps']} rps"
        )
...
class TestMemoryBenchmarks:
    ...
    def test_memory_usage_single_operation(self, sample_data_full, performance_metrics):
        ...
        assert result.shape == (402, 500)
        assert validation["single_operation_memory_mb"], (
            f"Memory usage was {memory_used:.2f}MB, target was {targets['single_operation_memory_mb']}MB"
        )
    ...
    def test_memory_stability_over_time(self, performance_metrics):
        ...
        assert validation["stability_growth_memory_mb"], (
            f"Memory grew by {memory_growth:.2f}MB over {num_operations} operations"
        )
