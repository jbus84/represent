...
class TestRealDataProcessing:
    ...
    def test_large_dataset_processing(self, sample_real_data):
        ...
        print(f"Processed {len(sample_real_data)} records in {processing_time:.3f}s ({records_per_second:.0f} rps)")
...
class TestRealDataValidation:
    ...
    def test_real_data_structure(self, sample_real_data):
        ...
        required_columns = [
            ...
            # Ask prices
            'ask_px_00', 'ask_px_01', 'ask_px_02', 'ask_px_03', 'ask_px_04',
            'ask_px_05', 'ask_px_06', 'ask_px_07', 'ask_px_08', 'ask_px_09',
            # Bid prices  
            'bid_px_00', 'bid_px_01', 'bid_px_02', 'bid_px_03', 'bid_px_04',
            'bid_px_05', 'bid_px_06', 'bid_px_07', 'bid_px_08', 'bid_px_09',
            # Ask volumes
            'ask_sz_00', 'ask_sz_01', 'ask_sz_02', 'ask_sz_03', 'ask_sz_04',
            'ask_sz_05', 'ask_sz_06', 'ask_sz_07', 'ask_sz_08', 'ask_sz_09',
            # Bid volumes
            'bid_sz_00', 'bid_sz_01', 'bid_sz_02', 'bid_sz_03', 'bid_sz_04',
            'bid_sz_05', 'bid_sz_06', 'bid_sz_07', 'bid_sz_08', 'bid_sz_09',
        ]
...
class TestRealDataPerformance:
    ...
    def test_real_data_latency(self, sample_real_data):
        ...
        assert latency_ms < 1000, f"Latency too high: {latency_ms:.2f}ms for {len(sample_real_data)} records"
...
class TestRealDataEdgeCases:
    ...
    def test_real_data_with_gaps(self, real_market_data):
        ...
        if len(real_market_data) >= 500000:  # Need enough data to sample from
            ...
            gapped_data = real_market_data.filter(
                pl.int_range(pl.len()).mod(10) == 0
            ).head(50000)
