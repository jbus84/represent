#!/usr/bin/env python3
"""
Test Triple Barrier Fixes

Quick test to verify the Triple Barrier logic fixes are working correctly.
"""
...
def test_triple_barrier_fixes():
    """Test the Triple Barrier fixes."""
    if not LIBRARIES_AVAILABLE:
        return
    
    print("🔧 TESTING TRIPLE BARRIER FIXES")
    print("=" * 60)
    ...
    for config in configs:
        ...
        try:
            ...
            generator = TargetGeneratorFactory.create("triple_barrier", **config["params"])
            ...
            for i in range(debug_samples):
                ...
                upper_barrier = entry_price + barrier_width  # Now absolute
                lower_barrier = entry_price - barrier_width  # Now absolute
            ...
            if discrepancies == 0:
                print("✅ TRIPLE BARRIER LOGIC FIXED!")
            else:
